...
public interface OKRService {
	...
	KeyResult updateKeyResult(String user, String period, String objective, String id, String title,long estimate, double confidence, double weight, double progress) throws ValidationException;
