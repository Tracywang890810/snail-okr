...
public class OKRHistoryDate {
	...
	public OKRHistoryDate(String user, String enterpriseId, String period, List<String> dates) {
		this.user = user;
	...
	public OKRHistoryDate(String user, String enterpriseId, String period) {
		this.user = user;
		this.enterpriseId = enterpriseId;
		this.period = period;
